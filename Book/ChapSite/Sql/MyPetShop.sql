...
ON 
( NAME = MyPetShop,
    FILENAME = 'H:\Users\Administrator\Desktop\Book\ChapSite\App_Data\MyPetShop.mdf',
    SIZE = 5MB,
    MAXSIZE = 50MB,
    FILEGROWTH = 1MB )
LOG ON
( NAME = MyPetShop_log,
    FILENAME = 'H:\Users\Administrator\Desktop\Book\ChapSite\App_Data\MyPetShop_log.ldf',
    SIZE = 3MB,
    MAXSIZE = 25MB,
    FILEGROWTH = 1MB )
